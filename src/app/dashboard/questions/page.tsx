  ...
  const questionsHistory = [
    {
      id: 1,
      question:
        "What were the main topics we discussed in last week's meeting?",
      answer:
        "In last week's meeting, the team primarily discussed three main topics: (1) Q2 product roadmap priorities, (2) upcoming customer feedback implementation, and (3) resource allocation for the new feature development.",
    ...
    },
    {
      ...
      answer:
        "The team decided to increase the Q3 marketing budget by 15% to support the new product launch. This includes additional allocations for digital advertising, event sponsorships, and hiring an external PR consultant for the first three months of the campaign.",
