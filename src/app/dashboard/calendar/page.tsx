    ...
    <main className="flex-1 px-4 py-6 max-w-5xl mx-auto w-full">
      <div className="grid md:grid-cols-[1fr_300px] gap-6">
        ...
        <div>
          <Card>
            <CardHeader>
              <CardTitle>{date?.toLocaleDateString(undefined, { month: 'long', day: 'numeric', year: 'numeric' })}</CardTitle>
              <CardDescription>{meetingsForSelectedDate?.length || 0} meetings</CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
              ...
              ) : meetingsForSelectedDate && meetingsForSelectedDate.length > 0 ? (
