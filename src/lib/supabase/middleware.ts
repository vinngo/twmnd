...
export async function updateSession(request: NextRequest, isProtectedRoute = false) {
  ...
  // Only redirect for protected routes or non-public paths
  if (!user && isProtectedRoute) {
    // No user and trying to access protected route, redirect to root
